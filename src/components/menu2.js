            ...
            <li class="do cp h5 cm">
              ...
              <div class="or">
                <ul
                  ...
                  tabindex="0"
                  data-baseweb="menu"
                  class="dv bj cn cm g5 ey a22 a23 cp cq vk vi vj vl a24 a25 cx a26"
                >
                  <li
                    role="option"
                    aria-selected="false"
                  ...
                  >
                    <a
                      ...
                      class="gf b5"
                    >
                      <div class="j3 gf b5 tg a27 a22 a23">About us</div>
                    </a>
                  </li>
                  <li
                    role="option"
                  ...
                  >
                    <a
                      ...
                      class="gf b5"
                    >
                      <div class="j3 gf b5 tg a27 a22 a23">How Uber works</div>
                    </a>
                  </li>
                  <li
                    role="option"
                  ...
                  >
                    <a
                      ...
                      class="gf b5"
                    >
                      <div class="j3 gf b5 tg a27 a22 a23">
                        Global citizenship
                      </div>
                    </a>
                  </li>
                  ...
                  >
                    <a
                      ...
                      class="gf b5"
                    >
                      <div class="j3 gf b5 tg a27 a22 a23">Newsroom</div>
                    </a>
                  </li>
                  <li
                    role="option"
                  ...
                  >
                    <a
                      ...
                      class="gf b5"
                    >
                      <div class="j3 gf b5 tg a27 a22 a23">Careers</div>
                    </a>
                  </li>
                </ul>
                <span></span>
            ...
            <li class="do cp h5 cm">
              ...
              <div class="or">
                <ul
                  ...
                  tabindex="0"
                  data-baseweb="menu"
                  class="dv bj cn cm g5 ey a22 a23 cp cq vk vi vj vl a24 a25 cx a2c a2d"
                >
                  <li class="c4 bw a2e bk cj a2f a2g">
                    <div class="c4 bw hf hg">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 24 24"
